...
def save_to_database(prediction, id_images):
    try:
        ...
        sql_insert_query = """INSERT INTO predictions (prediction, id_images) VALUES (%s, %s)"""  # Adjust SQL query to include id_images
